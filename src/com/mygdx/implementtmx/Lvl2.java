...
January 19th 2017
The level 2 class
This class implements all of the attributes of level 2 in the game. It adds all the enemies, chests, and doors of the level, setting their designated x,y position
...
public class Lvl2 extends AbstractLevel implements Screen {
    ...
    //variable used for when user dies
    ...
    public Lvl2(ImplementTmx g,MenuSwitch menuS) {
    ...
    public void show() {
        ...
        renderer = setTiledMap("Lvl2/Lvl2Detailed.tmx",cam, renderer,map,rects,"collisionObjects");
        map = renderer.getMap();
        ...
        //gets the door objects from this tiledmap. there are two doors in this map
        addDoor("doorLv1",doors,map,"Lv1",976,1030);
        addDoor("doorLv7",doors,map,"Lv7",280,1160);
       
        //for some reason all of the doors are shifted up. this fixes that
        doors.get(0).setY(doors.get(0).getY()-228);
        doors.get(1).setY(doors.get(1).getY()-485);
        ...
        enemies.get(0).setXPos(684);
        enemies.get(0).setYPos(1145);
        enemyFrames.add(0,enemies.get(0).getIdle('L'));
        enemies.get(1).setXPos(1004);
        enemies.get(1).setYPos(1145);
        enemyFrames.add(1,enemies.get(1).getIdle('L'));
        enemies.get(2).setXPos(1342);
        enemies.get(2).setYPos(879);
